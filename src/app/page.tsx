...
export default function Home() {
  ...
  return (
    <main className="flex items-center justify-center">
      <div className="desktop:w-[375px] bg-primary-500 min-h-screen w-full">
        <div className="relative flex flex-col items-center justify-center px-5">
          <section className="flex min-h-screen flex-col items-center justify-center gap-y-[28px]">
          ...
          <section className="fixed bottom-[55px] flex w-[375px] flex-col items-center justify-center gap-y-[36px] px-5">
